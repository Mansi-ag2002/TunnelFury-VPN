...
import com.CryptoInterface;
import com.DiffieHellmanHelper;
import com.GUIInterface;
import com.Helpers;
...
//			inFromServer.read(serverPublicKeyEncoded);
	        ...
	        m_gui.printf("Encoded pubk(client): " + Helpers.ByteToString(clientEncPubk));
	        ...
	        m_gui.printf("shared k(client): " + Helpers.ByteToString(sharedSecretKey));
